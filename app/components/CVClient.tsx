...
export default function CVClient() {
  ...
  useGSAP(
    () => {
      ...
      if (!isMobile) {
        ...
        gsap.to(".parallax-bg", {
          yPercent: 30, // Moves slightly slower than the scroll
          ease: "none",
          scrollTrigger: {
        ...
        // Slower text floating logic for depth
      ...
      // 3. STORY BEAT REVEALS (Fade in as you scroll)
      gsap.utils.toArray<HTMLElement>(".reveal-section").forEach((section) => {
        ...
        gsap.from(items, {
          scrollTrigger: {
            trigger: section,
            start: "top 85%", // Triggers nicely when entering
  ...
  return (
    <div ref={containerRef} className="flex flex-col w-full border-x border-border min-h-screen bg-background text-foreground overflow-hidden">
      {/* =========================================
          SECTION 01: HERO & IDENTITY
          ========================================= */}
      <section className="hero-section min-h-screen flex flex-col border-b border-border relative">
        <header className="grid grid-cols-1 md:grid-cols-[1fr_3fr] flex-1 relative z-10">
          ...
          <div className="p-6 md:p-12 pl-6 md:pl-16 flex flex-col justify-center bg-background hero-text-block will-change-transform transform-gpu">
            <h1 className="text-5xl md:text-8xl font-black uppercase leading-[0.8] tracking-tighter mb-6 overflow-hidden">
              <div className="hero-line">Raffi</div>
              <div className="hero-line">Achmad</div>
            ...
            <div className="hero-line flex flex-wrap gap-4 mt-8 font-mono text-xs uppercase">
              <a href="mailto:raffiachmad93@gmail.com" className="border border-border bg-background px-6 py-3 hover:bg-accent hover:text-background hover:border-accent transition-colors duration-200 cursor-pointer flex items-center gap-2 group">
              ...
              <a href="https://linkedin.com/in/raffi-achmad-r/" target="_blank" rel="noopener noreferrer" className="border border-border bg-background px-6 py-3 hover:bg-accent hover:text-background hover:border-accent transition-colors duration-200 cursor-pointer flex items-center gap-2 group">
              ...
              <a href="https://github.com/RaffiAchmadR" target="_blank" rel="noopener noreferrer" className="border border-border bg-background px-6 py-3 hover:bg-accent hover:text-background hover:border-accent transition-colors duration-200 cursor-pointer flex items-center gap-2 group">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 border-t border-border mt-auto relative z-20 bg-background">
          {["Next.js & React", "Flutter & Mobile", "Machine Learning", "UI/UX Architecture"].map((skill, i) => (
            <div key={skill} className={`hero-metric p-4 md:p-6 flex flex-col justify-between h-32 ${i !== 3 ? 'border-r border-border' : ''} will-change-transform transform-gpu`}>
      ...
      {/* =========================================
          ...
          ========================================= */}
      <section className="reveal-section min-h-screen flex flex-col border-b border-border bg-background relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 flex-1">
          ...
          <div className="p-6 md:p-12 border-b md:border-b-0 md:border-r border-border">
            <h2 className="reveal-item font-mono text-xs uppercase text-subtle mb-10 tracking-widest flex items-center gap-2 will-change-transform transform-gpu">
              <span className="w-2 h-2 bg-accent inline-block"></span> [ EDU_DATA ]
            </h2>

            <div className="space-y-12">
              <div className="reveal-item relative pl-6 border-l border-border will-change-transform transform-gpu">
          ...
          <div className="p-6 md:p-12 relative">
            {/* Sticky heading for tech stack reading */}
            <div className="sticky top-24 z-20 bg-background/90 backdrop-blur-md pb-4 pt-2 -mt-2">
              <h2 className="reveal-item font-mono text-xs uppercase text-subtle tracking-widest flex items-center gap-2 will-change-transform transform-gpu">
                <span className="w-2 h-2 bg-accent inline-block"></span> [ TECH_STACK ]
              </h2>
            </div>

            <div className="space-y-8 mt-6">
              <div className="reveal-item will-change-transform transform-gpu">
                ...
                <div className="flex flex-wrap gap-3 text-sm font-mono">
                  {["TypeScript", "React", "Next.js", "Vue", "Python", "Flutter", "Django", "HTML/CSS"].map(s => (
                    <span key={s} className="px-4 py-2 border border-border hover:border-accent hover:text-accent cursor-pointer transition-colors delay-0">{s}</span>
                  ))}
                </div>
              </div>
      ...
      <section className="reveal-section min-h-screen flex flex-col border-b border-border bg-background relative z-20">
        ...
        <div className="flex-1 flex flex-col">
          {/* EXP ITEM 1 */}
          <article className="reveal-item p-6 md:p-12 border-b border-border hover:bg-[#0c0c0e] transition-colors relative group flex-1 flex flex-col justify-center cursor-pointer will-change-transform transform-gpu">
          ...
          {/* EXP ITEM 3 */}
          <article className="reveal-item p-6 md:p-12 hover:bg-[#0c0c0e] transition-colors relative group flex-1 flex flex-col justify-center cursor-pointer will-change-transform transform-gpu">
            <div className="absolute top-0 left-0 w-1 h-0 bg-accent group-hover:h-full transition-all duration-300"></div>
            <header className="flex flex-col md:flex-row md:items-start justify-between mb-6">
              <div>
      ...
      {/* =========================================
          ...
          ========================================= */}
      <section className="reveal-section min-h-[80vh] flex flex-col bg-background relative z-20">
        <div className="p-6 md:p-8 bg-[#121214] border-b border-border flex justify-between items-center sticky top-0 z-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 flex-1">
          ...
          <div className="flex flex-col border-b lg:border-b-0 lg:border-r border-border">
            <article className="reveal-item p-6 md:p-10 border-b border-border group cursor-pointer transition-colors hover:bg-[#0c0c0e] will-change-transform transform-gpu">
            ...
            <article className="reveal-item p-6 md:p-10 group cursor-pointer transition-colors hover:bg-[#0c0c0e] will-change-transform transform-gpu">
              <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex flex-col">
            ...
            <article className="reveal-item p-6 md:p-10 group cursor-pointer transition-colors hover:bg-[#0c0c0e] flex-1 will-change-transform transform-gpu">
              <div className="flex justify-between items-start mb-4">
